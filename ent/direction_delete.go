...
func (dd *DirectionDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(direction.Table, sqlgraph.NewFieldSpec(direction.FieldID, field.TypeInt64))
...
// Where appends a list predicates to the DirectionDelete builder.
func (ddo *DirectionDeleteOne) Where(ps ...predicate.Direction) *DirectionDeleteOne {
